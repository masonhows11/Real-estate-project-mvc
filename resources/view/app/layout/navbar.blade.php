            ...
            <div class="offcanvas-logo">
                <div class="homec-header__logo">
                    <a href="<?= route('home.index') ?>"><img
                            src="<?= asset('app_assets/img/default/no-picture-available.jpg') ?>" alt="لوگو" /></a>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="homec-header__inside">
                        <div class="homec-header__group">
                            <div class="homec-header__logo">
                                <a href="<?= route('home.index') ?>">
                                    <img src="<?= asset('app_assets/img/default/no-picture-available.jpg') ?>"
                                        alt="#" />
                                </a>
                            </div>
                            <div class="homec-header__menu">
                                <div class="navbar">
                                    <div class="nav-item">
                                        <ul class="nav-menu menu navigation list-none">
                                            <li
                                                class="menu-item-has-children <?= currentUrl() == route('home.index') ? 'active' : '' ?> ">
                                                <a href="<?= route('home.index') ?>">صفحه اصلی </a>
                                                <!-- <ul class="sub-menu">
                                                    <li><a href="index.html">صفحه اصلی 1</a></li>
                                                    <li><a href="index-2.html">صفحه اصلی 2</a></li>
                                            ...
                                            <li
                                                class="menu-item-has-children <?= currentUrl() == route('ads_list') ? 'active' : '' ?>">
                                                <a href="#">ملک‌ها</a>
                                                <ul class="sub-menu">
                                            ...
                                            <li
                                                class="menu-item-has-children <?= currentUrl() == route('posts') ? 'active' : '' ?>">
                                                <a href="#">وبلاگ</a>
                                                <ul class="sub-menu">
                                                    <li><a href="<?= route('posts') ?>">وبلاگ</a></li>
                                                </ul>
                                            </li>
                                            <li class="<?= currentUrl() == route('contact_us') ? 'active' : '' ?>"><a
                                                    href="<?= route('contact_us') ?>">تماس با ما</a></li>
                                            <li class="<?= currentUrl() == route('about_us') ? 'active' : '' ?>"><a
                                                    href="<?= route('about_us') ?>">درباره ما</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="<?= route('admin.index') ?>" class="homec-btn"><span>پنل مدیریت</span></a>
                        ...
                        <div class="homec-header__button">
                            ...
                            <a href="<?= route('auth.logout') ?>" class="homec-btn"><span>خروج</span></a>

                        </div>
                        <?php } else {  ?>
                        <div class="homec-header__button">
                            <a href="<?= route('auth.register.form') ?>" class="homec-btn"><span>ثبت نام</span></a>
                            <a href="<?= route('auth.login.form') ?>" class="homec-btn"><span>ورود</span></a>
                        </div>
                        <?php } ?>
                    </div>
                </div>
