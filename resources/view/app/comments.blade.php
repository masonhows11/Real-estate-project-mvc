            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="form-group homec-form-input">
                        <input class="ecom-wc__form-input" type="text" name="f_name" placeholder="میشل هولدر" required="required" />
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="form-group homec-form-input">
                        <input class="ecom-wc__form-input" type="email" name="f_name" placeholder="ایمیل شما" required="required" />
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group homec-form-input">
