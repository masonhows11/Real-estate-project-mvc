                ...
                <div class="col-lg-8 ol-12">
                    <div class="list-group homec-list-tabs homec-list-tabs--v2" id="list-tab" role="tablist">
                        <a class="list-group-item active" data-bs-toggle="list" href="#homec-pd-tab1"
                            role="tab">جزئیات ملک</a>
                        <a class="list-group-item" data-bs-toggle="list" href="#homec-pd-tab2" role="tab">پلان های
                            طبقه</a>
                        <a class="list-group-item" data-bs-toggle="list" href="#homec-pd-tab3" role="tab">ویدئو ملک
                        </a>
                        <a class="list-group-item" data-bs-toggle="list" href="#homec-pd-tab4" role="tab">مکان ها
                        </a>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="homec-location-card mg-top-20">
                                                ...
                                                <p class="homec-location-card__desc">تهران ، زعفرانیه ، خیابان مهر تهران ،
                                                    زعفرانیه ، خیابان مهر</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="homec-location-card mg-top-20">
                                ...
                                <div class="homec-pdetails-tab__inner">
                                    <div class="homec-pdetails-tab--review">
                                        <div class="homec-testimonial homec-testimonial--review homec-border mg-top-30">
                                            <div class="homec-rating--main mg-btm-15">
                                                ...
                                                <span class="homec-primary-color">2 روز پیش</span>
                                            </div>

                                            <p class="homec-testimonial__text">“لورم ایپسوم متن ساختگی با تولید سادگی
                                    ...
                                    <div class="col-12 d-flex justify-content-center mg-top-40">
                                        <div class="homec-comments-form homec-comments-form--reviews">
                                            ...
                                            <p class="homec-comments-form__text">آدرس ایمیل شما منتشر نخواهد شد. فیلدهای
                                                الزامی مشخص شده اند *</p>
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="form-group homec-form-input">
                                                        <input class="ecom-wc__form-input" type="text" name="f_name"
                                                            placeholder="آرنولد برنر" required="required" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group homec-form-input">
                                                        <textarea class="ecom-wc__form-input" name="f_name" placeholder="نظرات"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-12 d-flex justify-content-end mg-top-20">
                                                    <button type="submit" class="homec-btn homec-btn__second"><span>ارسال
                                                            نظر</span></button>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="homec-property-ag homec-property-ag--side homec-bg-cover"
                        ...
                        <form action="#" class="homec-property-ag__form">
                            <div class="form-group">
                                <input type="text" name="first_name" placeholder="آرنولد" />
                            </div>
                            <div class="form-group">
                                <input type="text" name="last_name" placeholder="برنر" />
                            </div>
                            <div class="form-group">
                                <input type="email" name="fullname" placeholder="ایمیل" />
                            </div>
                            <div class="form-group">
                                <textarea name="Message" placeholder="توضیحات" required="required"></textarea>
                            </div>
                            <button type="submit"
                                class="homec-btn homec-btn__second homec-property-ag__button"><span>ارسال
                                    پیام</span></button>
                        </form>
                    </div>
                </div>
