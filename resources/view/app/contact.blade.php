...
@section('main_content')
                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <ul class="breadcrumb__menu list-none">
                            ...
                            <li class="active"><a href="<?= route('contact_us') ?>">تماس با ما</a></li>
                        </ul>
                        <h2 class="breadcrumb__title m-0">تماس با ما</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="homec-contact-form homec-bg-cover pd-top-80 pd-btm-80 mg-top-100"
             style="background-image: url('<?= asset('app_assets/img/contact-bg.jpg') ?>');">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="homec-property-ag homec-bg-cover"
                         style="background-image: url(<?= asset('app_assets/img/property-ag-bg.svg') ?>);">
                        <h3 class="homec-property-ag__title">تماس با ما</h3>

                        <form action="#" class="homec-property-ag__form">
                            <div class="form-group">
                                <input type="text" name="first_name" placeholder="میشل هولدر" />
                            </div>
                            <div class="form-group">
                                <input type="email" name="fullname" placeholder="ایمیل" />
                            </div>
                            <div class="form-group">
                                <input type="text" name="your_phone" placeholder="تلفن" />
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="homec-btn homec-btn__second homec-property-ag__button"><span>ارسال پیام</span></button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="homec-contact__middle homec-border">
                        ...
                        <div class="homec-contact__single">
                            ...
                            <div class="homec-contact__content">
                                <p class="homec-contact__label">آدرس</p>
                                <h3 class="homec-contact__title">تهران ، زعفرانیه ، خیابان مهر</h3>
                            </div>
                        </div>
                        ...
                        <div class="homec-contact__single">
                            <div class="homec-contact__icon">
                                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                            d="M17 0C7.63944 0 0 7.63997 0 17C0 26.3606 7.63997 34 17 34C26.3606 34 34 26.36 34 17C34 7.63944 26.36 0 17 0ZM17 32.0078C8.72465 32.0078 1.99219 25.2753 1.99219 17C1.99219 8.72465 8.72465 1.99219 17 1.99219C25.2753 1.99219 32.0078 8.72465 32.0078 17C32.0078 25.2753 25.2753 32.0078 17 32.0078Z"
                                    />
                                    <path
                                            d="M8.54687 26.4482C9.097 26.4482 9.54297 26.0023 9.54297 25.4521C9.54297 24.902 9.097 24.4561 8.54687 24.4561C7.99675 24.4561 7.55078 24.902 7.55078 25.4521C7.55078 26.0023 7.99675 26.4482 8.54687 26.4482Z"
                                    />
                                    <path
                                            d="M25.4531 9.54395C26.0033 9.54395 26.4492 9.09798 26.4492 8.54785C26.4492 7.99772 26.0033 7.55176 25.4531 7.55176C24.903 7.55176 24.457 7.99772 24.457 8.54785C24.457 9.09798 24.903 9.54395 25.4531 9.54395Z"
                                    />
                                    <path
                                            d="M7.84254 7.84351C7.45353 8.23252 7.45353 8.86318 7.84254 9.25219C8.23154 9.6412 8.8622 9.6412 9.25121 9.25219C9.64022 8.86318 9.64022 8.23252 9.25121 7.84351C8.86227 7.45451 8.23154 7.45451 7.84254 7.84351Z"
                                    />
                                    <path
                                            d="M24.7488 24.7478C24.3598 25.1368 24.3598 25.7675 24.7488 26.1565C25.1378 26.5455 25.7685 26.5455 26.1575 26.1565C26.5465 25.7675 26.5465 25.1368 26.1575 24.7478C25.7685 24.3588 25.1377 24.3588 24.7488 24.7478Z"
                                    />
                                    <path
                                            d="M17 8.03516C17.5501 8.03516 17.9961 7.58917 17.9961 7.03906V5.04688C17.9961 4.49677 17.5501 4.05078 17 4.05078C16.4499 4.05078 16.0039 4.49677 16.0039 5.04688V7.03906C16.0039 7.58917 16.4499 8.03516 17 8.03516Z"
                                    />
                                    <path
                                            d="M17 25.9648C16.4499 25.9648 16.0039 26.4108 16.0039 26.9609V28.9531C16.0039 29.5032 16.4499 29.9492 17 29.9492C17.5501 29.9492 17.9961 29.5032 17.9961 28.9531V26.9609C17.9961 26.4108 17.5501 25.9648 17 25.9648Z"
                                    />
                                    <path
                                            d="M8.03516 17C8.03516 16.4499 7.58917 16.0039 7.03906 16.0039H5.04688C4.49677 16.0039 4.05078 16.4499 4.05078 17C4.05078 17.5501 4.49677 17.9961 5.04688 17.9961H7.03906C7.58917 17.9961 8.03516 17.5501 8.03516 17Z"
                                    />
                                    <path
                                            d="M25.9648 17C25.9648 17.5501 26.4108 17.9961 26.9609 17.9961H28.9531C29.5032 17.9961 29.9492 17.5501 29.9492 17C29.9492 16.4499 29.5032 16.0039 28.9531 16.0039H26.9609C26.4108 16.0039 25.9648 16.4499 25.9648 17Z"
                                    />
                                    <path
                                            d="M17.9961 16.5879V11.0239C17.9961 10.4738 17.5501 10.0278 17 10.0278C16.4499 10.0278 16.0039 10.4738 16.0039 11.0239V17.0005C16.0039 17.2647 16.1089 17.518 16.2957 17.7049L22.2723 23.6814C22.6612 24.0704 23.2919 24.0704 23.6809 23.6814C24.0699 23.2924 24.0699 22.6618 23.6809 22.2727L17.9961 16.5879Z"
                                    />
                                </svg>
                            </div>
                            <div class="homec-contact__content">
                                <p class="homec-contact__label">ایمیل</p>
                                <h3 class="homec-contact__title">
                                    <a href="#">
                                        <span class="__cf_email__">info.contact@gmail.com</span>
                                    </a>
                                </h3>
                            </div>
                        </div>
            ...
            <div class="row mg-top-60">
                <div class="col-12">
                    <div class="homec-gmap-canvas homec-gmap-canvas--map">
                        <iframe id="homec-gmap-contact" class="homec-gmap-iframe" src="https://maps.google.com/maps?q=&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"></iframe>
                    </div>
                </div>
            </div>
        </div>
