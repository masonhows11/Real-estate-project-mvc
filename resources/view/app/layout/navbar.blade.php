                ...
                <div class="col-12">
                    <div class="homec-header__inside">
                        ...
                        <div class="homec-header__button">
                            ...
                            <a href="<?= route('admin.index') ?>" class=""><span>ادمین </span></a>
                        ...
                        <?php } else { ?>
                        <div class="homec-header__button">
                            <a href="<?= route('auth.register.form') ?>" class=""><span>ثبت نام</span></a>
                            <a href="<?= route('auth.login.form') ?>" class=""><span>ورود</span></a>
                        </div>
                        <?php } ?>
                    </div>
                </div>
