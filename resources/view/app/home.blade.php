...
@section('main_content')
    ...
    <!-- latest estate -->
    <section class="homec-properties homec-bg-cover pd-top-120 pd-btm-120"
             style="background-image: url(<?= asset('app_assets/img/bg-shape-four.svg') ?>);">
        ...
        <div class="container">
                ...
                <div class="col-12">
                    <div class="homec-section__head text-center section-white mg-btm-30">
                        <span class="homec-section__badge homec-section__badge--small homec-primary-color m-0"
                              data-aos="fade-in" data-aos-delay="300">مشاهده تمام 329 ملک جدید</span>
            ...
            <div class="row">
                    ...
                    <div class="homec-property">
                        <div class="homec-property__head">
                            ...
                            <div class="homec-property__hsticky">
                                ...
                                <a href="agent-detail.html" class="homec-property__asticky">
                                    ...
                                    <h4 class="homec-property__asticky--label"><?= $ads->user()->first_name ?><span>مشاور</span>
                                    </h4>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="homec-property__body">
                            <div class="homec-property__topbar">
                                <div class="homec-property__price"><?= number_format($ads->amount) ?>
                ...
                <?php } ?>
                        ...
                        <!-- best estate -->
                <section class="homec-properties homec-bg-cover pd-top-120 pd-btm-120"
                         style="background-image: url('app_assets/img/bg-shape-four.svg');">
                    <div class="homec-shape">
                        <div class="homec-shape-single homec-shape-7"><img src="app_assets/img/anim-shape-4.svg"
                                                                           alt="#"/></div>
                        <div class="homec-shape-single homec-shape-8"><img src="app_assets/img/anim-shape-5.svg"
                                                                           alt="#"/></div>
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="homec-section__head text-center section-white mg-btm-30">
                                    <span class="homec-section__badge homec-section__badge--small homec-primary-color m-0"
                                          data-aos="fade-in"
                                          data-aos-delay="300">مشاهده تمام 268 از بهترین ملک ها</span>
                                    <h2 class="homec-section__title" data-aos="fade-in" data-aos-delay="400">بهترین ملک
                                        ها</h2>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="homec-property__head">
                                        ...
                                        <div class="homec-property__hsticky">
                                            ...
                                            <a href="agent-detail.html" class="homec-property__asticky">
                                                ...
                                                <h4 class="homec-property__asticky--label"><?= $ads->user()->first_name ?>
                                                    <span>مشاور</span></h4>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-center mg-top-40" data-aos="fade-in"
                                 data-aos-delay="300">
