                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="homec-blog">
                            <div class="homec-blog__head">
                                <div class="homec-overlay homec-blog__overlay"></div>
                                <a href="blog-single.html"><img src="<?= $ad->image ? asset($ad->image) : asset('app_assets/img/blog-1.jpg') ?>" alt="#" /></a>
                                ...
                                <div class="homec-blog__content">
                                    ...
                                    <h3 class="homec-blog__title"><a href="<?= route('ads',['id'=>$ad->id]) ?>"><?= $ad->title ?></a></h3>
                                    <div class="home-blog__button homec-border-top">
