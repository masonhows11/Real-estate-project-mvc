...
@section('custom_script')
    <script type="text/javascript">
        $(window).on('load', function () {
            ...
            load_ajax_posts = document.getElementById("load-ajax-posts");
                ...
                success: function (result) {
                    ...
                    for (let i = 0; i < posts.length; i++) {
                        htmlString += ' <div class="col-lg-4 col-md-6 col-12"> ' +
                            ...
                            ' <div class="homec-blog__head">' +
                            '  <div class="homec-overlay homec-blog__overlay"></div>' +
                            '  <a href="blog-single.html"><img src="<?= $post->image ? asset($post->image) : asset('app_assets/img/blog-1.jpg') ?>"alt="#"/></a>' +
                            ...
                            ' </li>' +
                            ' </ul>' +
                            ' <h3 class="homec-blog__title"><a href="<?= route('post', ['id' => $post->id]) ?>"><?= $post->title ?></a> </h3>' +
                            ' <div class="home-blog__button homec-border-top">' +
                            ' <a href="<?= route('post', ['id' => $post->id]) ?>" class="homec-blog__btn">' +
                            'ادامه مطلب ' +
