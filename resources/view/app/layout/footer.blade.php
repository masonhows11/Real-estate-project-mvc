            ...
            <div class="col-12">
                <div class="homec-form mg-top-100">
                    ...
                    <form class="homec-form__form">
                        ...
                        <button type="submit" class="homec-btn"><span>اشتراک</span></button>
                    </form>
                </div>
            </div>
        </div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <defs>
                                                    <clipPath id="clip0_1"><rect width="24" height="24" /></clipPath>
                                                </defs>
                                            </svg>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <defs>
                                                    <clipPath id="clip0_2"><rect width="24.0001" height="24" /></clipPath>
                                                </defs>
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <defs>
                                                    <clipPath id="clip0_3"><rect width="23.9531" height="24" /></clipPath>
                                                </defs>
                                            </svg>
                                        </a>
                                    </li>
